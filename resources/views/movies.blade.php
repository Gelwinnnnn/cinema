...
@section('content')
    <section class="w-screen px-16 py-8">
        <h1 class="w-full text-center font-bold text-5xl text-yellow-400">Now Playing</h1>
        <div class="my-8 grid grid-cols-3 gap-8">
            @foreach ($movies as $movie)
                <div class="w-[400px] bg-green-200 rounded-xl h-[180px] p-8 flex-col flex justify-center">
